...
| **안태현**                                                                                                                                                                                                                                                                                                                               | **윤태훈**                                                                                                                                                                                                                                                                                                                       | **이민정**                                                                                                                                                                                                                                                            |
| ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| <div align="center">- 전체 일정 관리<br/>- 데이터 전처리<br/>- 데이터 재구성</div>                                                                                                                                                                                                                                                       | <div align="center">- 데이터 통계 및 분석<br/>- 데이터 전처리<br/>- HTML 구현</div>                                                                                                                                                                                                                                              | <div align="center">- 데이터 수집<br/>- 데이터 시각화 구현</div>                                                                                                                                                                                                      |
...
- 체계적인 협업과 안정적인 배포를 위해 Git Flow 전략을 채택했습니다.
...
| 브랜치                                | 역할                                                                            | 병합 대상                         |
| ------------------------------------- | ------------------------------------------------------------------------------- | --------------------------------- |
| <div align="center">**main**</div>    | <div align="center">프로젝트 최종 완성본, 배포 가능한 안정적 버전</div>         | <div align="center">-</div>       |
| <div align="center">**develop**</div> | <div align="center">각 기능들을 통합하는 개발 브랜치, 테스트 및 검증</div>      | <div align="center">main</div>    |
| <div align="center">**feature**</div> | <div align="center">개별 기능 단위 개발 (데이터 분석, 시각화, 웹 구현 등)</div> | <div align="center">develop</div> |

<br/>

### 작업 플로우

1. **기능 개발 시작**: `develop`에서 `feature/기능명` 브랜치 생성
2. **개별 작업**: 각자의 feature 브랜치에서 담당 기능 개발
